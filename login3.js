...
const lastNames = document.getElementById('last-Name');

getform.addEventListener('submit',function(e){
    e.preventDefault();

    const firstNamesValue = firstNames.value;
    const lastNamesValue = lastNames.value;

    // localStorage.setItem('myObject',JSON.stringify([firstNameValue, lastNameValue]))

    localStorage.setItem('first-name', firstNamesValue);
    localStorage.setItem('last-name', lastNamesValue);
